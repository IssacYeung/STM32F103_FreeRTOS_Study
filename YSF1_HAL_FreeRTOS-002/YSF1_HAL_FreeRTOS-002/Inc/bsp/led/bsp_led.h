...
#define LED3                          (uint8_t)0x03
#define LED4													(uint8_t)0x04
...
#define LED4_ON                       HAL_GPIO_WritePin(LED4_GPIO,LED4_GPIO_PIN,GPIO_PIN_SET)    // 输出高电平
#define LED4_OFF                      HAL_GPIO_WritePin(LED4_GPIO,LED4_GPIO_PIN,GPIO_PIN_RESET)  // 输出低电平
